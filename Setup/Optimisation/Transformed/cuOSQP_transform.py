...
def time_optimisation(number_of_satellites: int, prediction_horizon: int = None, plot_results: bool = False,
    ...
    Fx_values, Fu_values = update_fx_and_fu(Fx_full_base, Fu_full_base, problem['x0_abs'], sparse=False)
    ...
    for i in range(nsim):
        ...
        # print(states[:10, i+1])
        # print(inputs[:10, i])
        Fx_values, Fu_values = update_fx_and_fu(Fx_full_base, Fu_full_base, states[:, i + 1], sparse=False)
