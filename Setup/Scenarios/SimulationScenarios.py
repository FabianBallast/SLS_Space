...
class SimulationScenarios(Enum):
    ...
    sim_35_minute = Simulation(simulation_duration=2100)
    ...
    sim_2_5_hour = Simulation(simulation_duration=7200 + 1800)
    sim_3_hour = Simulation(simulation_duration=7200 + 3600)
    sim_6_hour = Simulation(simulation_duration=6 * 3600)
    sim_7_hour = Simulation(simulation_duration=7 * 3600)
