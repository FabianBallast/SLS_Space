...
timers_to_run = [Gurobi_timer, CVXPY_timer, SLS_timer]
timer_names = ['Gurobi', 'CVXPY', 'SLS']
satellite_array = [np.logspace(np.log10(3), np.log10(15), num=5, dtype=int),
                   np.logspace(np.log10(3), np.log10(15), num=5, dtype=int),
                   np.logspace(np.log10(3), np.log10(15), num=5, dtype=int)]
